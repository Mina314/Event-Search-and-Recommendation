...
public class MongoDBTableCreation {
	...
	public static void main(String[] args) throws ParseException {
		...
		// Step 2: create new tables, populate data and create index. '1111', '938c2cc0dcc05f2b68c4287040cfcf71', 'John', 'Smith'
		db.getCollection("users").insertOne(new Document().append("first_name", "John").append("last_name", "Smith")
				.append("password", "938c2cc0dcc05f2b68c4287040cfcf71").append("user_id", "1111"));
		...
		db.getCollection("items").createIndex(new Document().append("address", "text").append("name", "text"));
